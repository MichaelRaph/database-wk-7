-- QUESTION 1 Create new table in 1NF
...
-- Insert atomic values (1 product per row)
...
-- OrderProducts table: Product and Quantity depend on OrderID + Product
